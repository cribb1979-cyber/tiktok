...
// Samma auth-header/historik som där — se den utförliga kommentaren i generate-did-video.ts.
// `Basic ${btoa(apiKey)}` (hela nyckelsträngen, inklusive kolon, base64-kodad).
